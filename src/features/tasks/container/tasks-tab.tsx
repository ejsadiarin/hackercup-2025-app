    ...
    <div className="flex flex-col gap-4 pb-12">
      ...
      <div className="mt-48">
        <button
          ...
          className="flex w-full justify-center border-2 bg-[#A600A9] outline-none text-white px-4 py-2 rounded-lg font-bold"
        >
          {isLoading ? "Loading..." : "Start my Day!"} {/* Change button text */}
        </button>
      </div>
    </div>
  );
